...
import logo from '../assets/batua.png'
        ...
        <div className="border-b-[#2d2c2c] border-b-[2px]">
            <div className="grid grid-cols-12 my-10 md:mx-16 mx-8 font-[Montserrat]">
                <div className="col-span-4 flex gap-12 items-center justify-between">
                    ...
                    <Link to={'/redeem'}><span className="text-[#7b3fe4] hidden md:block font-semibold uppercase">Redeem</span></Link>
                    <Link to={'/create-link'}><span className="text-[#7b3fe4] hidden md:block font-semibold uppercase">Create</span></Link>
                    <Link to={'/my-nft'}><span className="text-[#7b3fe4] hidden md:block font-semibold uppercase">My&nbsp;NFT</span></Link>
                </div>
                <div className="col-span-5"></div>
                <div className="col-span-3 flex items-center justify-end text-[#7b3fe4] text-sm md:text-base">
                        ...
                        <Popover
                            content={<div className="w-[250px]" onClick={e => setMenuOpen(false)}>
                                <div className="flex flex-col gap-3">
                                    <Link to={'/redeem'}><span className="text-[#7b3fe4] font-semibold uppercase">Redeem</span></Link>
                                    <Link to={'/create-link'}><span className="text-[#7b3fe4] font-semibold uppercase">Create</span></Link>
                                    <Link to={'/my-nft'}><span className="text-[#7b3fe4] font-semibold uppercase">My&nbsp;NFT</span></Link>
