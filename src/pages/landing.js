        ...
        <>
            <div className="grid md:grid-cols-2 gap-y-20 md:gap-y-0">
                <div className="h-full flex gap-8 flex-col justify-center text-[Montserrat] order-2">
                    <div className="">
                        <h1 data-aos="fade-up" className="text-[#bba3e3] uppercase text-5xl font-[Oswald] leading-normal tracking-widest">Create your Red <br /> Envelope</h1>
                    ...
                    <div>
                        <Link to={'/create-link'}>
                            <button data-aos-delay={200} data-aos="fade-up" className="bg-[#7b3fe4] rounded-md flex gap-2 px-3 py-2 items-center font-semibold">Create Now <AiOutlineArrowRight className="text-xl" /></button>
                        </Link>
                    </div>
